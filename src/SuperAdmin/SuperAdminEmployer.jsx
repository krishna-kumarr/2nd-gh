...
import EmployerDetailedView from './Resuable_Comp/EmployerDetailedView'
import EmployerCard from './Resuable_Comp/EmployerCard'
import SuperAdminContext from '../SuperAdminContext'
import InputGroup from '../InputGroup'
import Input from '../Input'


const SuperAdminEmployer = () => {
        ...
        <div className="col-12 superAdmin-rightSide-Component-content-height placeholder-glow">
            <div className="container-fluid px-lg-4 h-100">
                ...
                <div className="col-12 col-lg-4 h-100 py-3">
                    ...
                    {/* candidates cards  */}
                    <div className="d-flex flex-wrap overflow-scroll superAdmin-professional-cards">
                        {
                            initialGlow ? 
                                a.map((value, index) => {
                                    return (
                            ...
                            a.map((v,i)=>{
                                return (
                                <div className="card w-100 mb-2 rounded-2 border-0" key={i}>
                                    <div className="card-body">
                                    <EmployerCard
...
export default SuperAdminEmployer